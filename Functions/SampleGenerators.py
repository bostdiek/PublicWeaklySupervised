...
# Function to make a data set which has percentage_A samples drawn from
# parameters_A and 1-percentage_A drawn from parameters_B. The TotalSize
# is defaulted to 200000 but can be changed.
...
# Function to make a data set which has percentage_A samples drawn from
# parameters_A and 1-percentage_A drawn from parameters_B.
# This function labels the data with percentage_A_Expected even
# though percentage_A is the real value used in splitting the data.


def MakeSamplesWithError(parameters_A,
                         parameters_B,
                         percentage_A,
...
# Function to make a data set which has percentage_A samples drawn
# from parameters_A and 1-percentage_A drawn from parameters_B.
# This function labels the data with percentage_A_Expected even though
# percentage_A is the real value used in splitting the data.
